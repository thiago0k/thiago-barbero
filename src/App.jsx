      ...
      <div className="flex justify-center">
        <header className="contenedor-headers fixed z-10 top-2 rounded-3xl p-5 h-1 hidden sm:block">
          <ul className="flex h-full justify-center items-center list-none gap-5 text-white">
            ...
            <li onClick={() => handleClick(3)} className="cursor-pointer rounded-3xl">
              <img className="w-5" src={`src/iconos/${isDarkMode ? 'sol' : 'luna'}.png`} alt={isDarkMode ? 'sol' : 'luna'} />
            </li>
          </ul>
        </header>
      </div>

      <main style={{ background: isDarkMode ? 'white' : '#19192d' }} className="flex flex-col">
        <section style={{ background: isDarkMode ? 'white' : '#19192d' }} className="w-full min-h-screen">
          <div className="contenedor-presentacion">
            <ul className="contenedor-interior-presentacion">
              ...
              <li className="item-presentacion uno">
                <h1 style={{ color: isDarkMode ? 'black' : 'white' }}>Hola! Soy Thiago,</h1>
              </li>
              <li style={{ color: isDarkMode ? 'black' : 'white' }} className="item-presentacion">
                <h3>Apasionado por la tecnología.</h3>
                <strong><br />Aprendo y supero nuevos retos semanalmente y analizo cómo mejoran mis habilidades a través de ellos.</strong>
              </li>
              <div className="parte-2">
                ...
                <a href="https://www.linkedin.com/in/tiago-elias-000389305/">
                  <svg style={{ color: isDarkMode ? '#322e52' : 'white' }} className="size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        <section style={{ background: isDarkMode ? 'white' : '#19192d' }} id="seccion1" className="min-h-screen">
          <div className="flex justify-center">
            <div className="w-full max-w-screen-lg flex flex-col gap-7">
              ...
              <Proyectos cambio={{ color: isDarkMode ? '#1e293b' : 'white' }} />
              <Proyectos cambio={{ color: isDarkMode ? '#1e293b' : 'white' }} />
            </div>
          </div>
        </section>
        <section style={{ background: isDarkMode ? 'white' : '#19192d' }} className="lg:mt-28 lg:ml-20 mt-11" id="seccion2">
          <SobreMi cambiar={{ color: isDarkMode ? '#1e293b' : 'white' }} />
        </section>
      </main>
      <div className="flex justify-center">
  <footer className="sm:hidden fixed bottom-4 h-[54px] max-w-4xl mx-auto z-10 bg-white rounded-md">
    <ul style={{ border: isDarkMode ? 'solid 1px #dcdcdc' : 'none', borderRadius: isDarkMode ? '0.4rem' : '0' }} className="contenedor-ul flex justify-center items-center h-full list-none">
      {['Proyectos', 'Sobre Mi', 'Contacto'].map((item, index) => (
        <li key={index} onClick={() => handleClick(index)} className={`items text-lg rounded-md p-3 ${selectedIndex === index ? 'bg-blue-400' : 'bg-white'}`}>
          <a className="text-black" href={index < 2 ? `#seccion${index + 1}` : (index === 2 ? 'mailto:tiagoelias289@gmail.com' : undefined)} target={index === 2 ? '_blank' : '_self'} rel={index === 2 ? 'noopener noreferrer' : undefined}>
            {item}
          </a>
        </li>
      ))}
      <li onClick={() => handleClick(3)} className={`cursor-pointer rounded-md text-lg p-3 ${selectedIndex === 3 ? 'bg-blue-400' : 'bg-white'}`}>
        <img className="w-4" src={`src/iconos/${isDarkMode ? 'sol' : 'luna'}.png`} alt={isDarkMode ? 'sol' : 'luna'} />
      </li>
    </ul>
  </footer>
</div>
...
<div className="m-auto flex flex-col lg:flex-row w-[95%] items-center lg:items-start">
  <div className="lg:w-1/2 order-1 lg:order-1">
    <div>
      <h1 style={cambiar} className="flex gap-3 ml-5 md:ml-0">
